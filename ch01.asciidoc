...
The Kubeflow project has a link:$$https://www.kubeflow.org/docs/started/getting-started-minikube/$$[frequently updated guide on how to install Kubeflow with Minikube at https://www.kubeflow.org/docs/started/getting-started-minikube/]. You may wish to follow this guide instead

==== Installing Kubeflow dependencies

Kubeflow has relatively few dependencies, most of the heavy lifting is done inside of containers which ship with their requirements. Thankfully, even the minimal Kubeflow dependencies can be automatically installed along with Kubeflow by running X/Y/Z.
