...
Kubeflow's mission is to make machine learning composable, portable, and scalable.

Kubeflow's core components can be used indepedently to facilitate specific stages of machine learning, or composed together to form end-to-end pipelines. Let's look at some of these components in greater detail.
