...
Containerization means no more "it worked on my machine" or "oh yeah, we forgot about just one, you need package this extra package."
...
Once you have the dependencies installed, you can now install Kubeflow with <<install_kf>>, and optionally add it to your path.
