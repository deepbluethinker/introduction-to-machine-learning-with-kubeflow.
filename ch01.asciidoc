...
We briefly look at some alternatives in <<alternatives_to_kubeflow>> for you to explore.
...
Kubeflow has relatively few system dependencies, most of the heavy lifting is done inside containers which are already built with their requirements.
