...
This book is not intended to serve as your first introduction to machine learning, <<assumptions_about the audience>> has pointers to some resources that may be useful if you are just getting started on your machine learning journey.
