...
This book assumes that you either have the basics of machine learning well understood, or are working with someone who does. If you don't, there are many excellent introduction books on machine Learning
